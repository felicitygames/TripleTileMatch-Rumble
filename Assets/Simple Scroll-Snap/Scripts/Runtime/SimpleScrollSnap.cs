...
namespace DanielLochner.Assets.SimpleScrollSnap
{
    ...
    {
        public static SimpleScrollSnap inst;
        ...
        {
            //Only for Statestic Screen
            TargetPanel = panelNumber;

            /* if(GameManager.inst.statesticScreen != null)
                 StatesticScreenController.inst.Set_ModeHeader_Position(panelNumber);
             if (GameManager.inst.sudokuRulesScreen != null)
                 SudokuRulesScreenController.inst.Sudoku_Rules_Screen_Manage(panelNumber);*/
